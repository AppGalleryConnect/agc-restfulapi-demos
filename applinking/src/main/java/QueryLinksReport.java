...
public class QueryLinksReport {
    ...
    private static final String YOUR_PRODUCT_ID = "7364300*****4583900";

    // replace with your App linking
    private static final String YOUR_APP_LINKING= "https://p*****a.drcn.agconnect.link/7***W";

    private static final String GATEWAY_URL = "https://connect-api.cloud.huawei.com/api/oauth2/v1/token";

    private static final String LINK_REPORT_URL = "https://connect-api.cloud.huawei.com/api/applinking/v1/links-report";



    public static void main(String[] args) {
        String token = getToken();
        queryAppLinkingReport(token);
    }

    public static void queryAppLinkingReport(String token) {
        HttpGet get = new HttpGet(LINK_REPORT_URL + "?shortUrl=" + YOUR_APP_LINKING);
