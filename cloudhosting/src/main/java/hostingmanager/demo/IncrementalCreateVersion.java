...
import static hostingmanager.constants.Constants.MODIFY_FILE_LIST;
...
public class IncrementalCreateVersion {
     ...
     * 基线版本ID
     */
    private static final String BASE_VERSION_ID = "hx7S2LSDTaSL1egJLl1C4w";

    /**
     * Incremental version filePath
     */
    private static final String FILE_PATH = "src/main/resources/static/image.zip";

    private static final String SITE_NAME = "hostingdemo-test";
    ...
    public static void main(String[] args) {
        try {
            ...
            if (!StringUtils.equals(createVersionRespObject.getString("code"), "0")) {
                throw new RuntimeException("create incremental version failed.");
            }
            ...
            System.out.println("Success to create incremental version, versionId is " + versionId);

            // 4.delete unnecessary files in the baseline version
            System.out.println("======================step 4 modify fileList======================");
            List<String> deleteFiles = Arrays.asList("/image/yanxishe.png", "/image/sitemanager.png");
            JSONObject modifyFileListReq = new JSONObject();
            modifyFileListReq.put("siteId", siteId);
            modifyFileListReq.put("version", versionId);
            modifyFileListReq.put("deleteFiles", deleteFiles);

            String modifyFileListResp = HttpClientUtil.getInstance()
                .sendPost(StringUtils.join(DOMAIN, MODIFY_FILE_LIST), JSON.toJSONString(modifyFileListReq), token);
            JSONObject modifyFileListRespObject = JSONObject.parseObject(modifyFileListResp);
            if (!StringUtils.equals(modifyFileListRespObject.getString("code"), "0")) {
                throw new RuntimeException("modify fileList failed.");
            }
            System.out.println("Success to modify fileList.");

            // 5.get version uploadInfo
            System.out.println("======================step 5 get uploadInfo======================");
            ...
            // 6.upload version file
            System.out.println("======================step 6 upload file======================");
            ...
            // 7.merge version
            System.out.println("======================step 7 merge version======================");
            ...
            // 8.get versionStatus
            System.out.println("======================step 8 get versionStatus======================");
            ...
            // 9.release sandbox
            System.out.println("======================step 9 release sandbox ======================");
            ...
            // 10.query publishStatus
            System.out.println("======================step 10 get publishStatus======================");
            ...
            // 11.release version production
            System.out.println("======================step 11 release production ======================");
            // environment: 0--production 1--sandbox
            ...
            // 12.query version publishStatus
            System.out.println("======================step 12 get publishStatus======================");
