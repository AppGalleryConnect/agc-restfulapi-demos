...
/**
 * 获取付费下载的报表:OrderDetailReportDemo
 */
public class OrderDetailReportDemo {
    ...
    private static void getReport(String token) {
        ...
        String queryType = "0";
        String startTime = "20201128160000";
        String endTime = "20201228155959";
        ...
        String url = String.format(
            Locale.ROOT, "%s/api/report/distribution-operation-quality/v1/orderDetailExport/" + appId + "?"
                + "language=" + language + "&queryType=" + queryType + "&startTime=" + startTime + "&endTime=" + endTime + conditions.toString(),
            GATEWAY_URL);
