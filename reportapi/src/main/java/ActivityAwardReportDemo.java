...
/**
 * 获取给指定用户群发奖的报表:ActivityAwardReportDemo
 */
public class ActivityAwardReportDemo {
    ...
    private static void getReport(String token) {
        ...
        filterConditionValue.add("939130");
        ...
        String url = String.format(
            Locale.ROOT, "%s/api/report/distribution-operation-quality/v1/activityAwardExport/" + appId + "?"
