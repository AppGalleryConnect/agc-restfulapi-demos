...
/**
 * 获取优惠券活动的报表:ActivityCouponReportDemo
 */
public class ActivityCouponReportDemo {
    ...
    private static void getReport(String token) {
        ...
        filterCondition.add("activityId");
        filterConditionValue.add("123456");
        ...
        String url = String.format(
            Locale.ROOT, "%s/api/report/distribution-operation-quality/v1/activityCouponExport/" + appId + "?"
                + "language=" + language + "&startTime=" + startTime + "&endTime=" + endTime + conditions.toString(),
            GATEWAY_URL);
