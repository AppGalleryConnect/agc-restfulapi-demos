...
/**
 * 获取应用内付费的报表:IAPReportDemo
 */
public class IAPReportDemo {
    ...
    private static void getReport(String token) {
        ...
        String startTime = "20201217";
        String endTime = "20210115";
        ...
        filterConditionValue.add("AppGallery");
        ...
        String url = String.format(
            Locale.ROOT, "%s/api/report/distribution-operation-quality/v1/IAPExport/" + appId + "?"
                + "language=" + language + "&startTime=" + startTime + "&endTime=" + endTime + conditions.toString()+ "&currency=" + currency,
            GATEWAY_URL);
