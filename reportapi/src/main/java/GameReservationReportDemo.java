...
/**
 * 获取预约的报表:GameReservationReportDemo
 */
public class GameReservationReportDemo {
    ...
    private static void getReport(String token) {
        ...
        String url = String.format(
            Locale.ROOT, "%s/api/report/distribution-operation-quality/v1/gameReservationExport/" + appId + "?"
